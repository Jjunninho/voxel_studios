// js/main.js - VERSÃO COM IA INTEGRADA E MODULAR
...
function generateTexture() {
    ...
    for (let y = 0; y < size; y++) {
        for (let x = 0; x < size; x++) {
            ...
            // ========================================
            // 🎨 RENDERIZA O PIXEL USANDO O MODO ATUAL
            // ========================================
    ...
    // 🛡️ GUARDIÃO UNIVERSAL - Valida baseado nos metadados do modo
    if (!shouldValidateSaturation(currentRenderMode)) {
        // Modos que NÃO validam (ex: solid)
        infoContainer.innerHTML = `Visualização da Textura - Modo: ${currentRenderMode.toUpperCase()}`;
        visualVariance = 999;
    } else {
        // 🔍 Modos que VALIDAM saturação
