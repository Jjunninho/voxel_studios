...
const ProceduralUI = {
    ...
    exportToEditor() {
        ...
        // 🔥 GERA O JSON NORMALIZADO (COMPATÍVEL COM EDITOR PRINCIPAL)
        const data = {
            textureRecipe: null, // Opcional, mantemos null por enquanto
            customColors: [],
        ...
        ProceduralEngine.showToast('✅ Dados formatados e enviados!', 'success');
