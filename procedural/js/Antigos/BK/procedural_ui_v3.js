...
const ProceduralUI = {
    ...
    setupEventListeners() {
        ...
        if (scaleInput) {
            scaleInput.addEventListener('input', (e) => {
                ...
                // Live Update
                if (ProceduralEngine.previewBlocks.length > 0) {
    ...
    exportToEditor() {
        // Combina os arrays da nova Engine
        const world = ProceduralEngine.worldBlocks || [];
        const preview = ProceduralEngine.previewBlocks || [];
        // Se a engine antiga estiver rodando e generatedBlocks existir, usa como fallback
        const generated = ProceduralEngine.generatedBlocks || [];
        
        const allBlocks = [...world, ...preview, ...generated];
        
        // Remove duplicatas (caso generatedBlocks contenha referências)
